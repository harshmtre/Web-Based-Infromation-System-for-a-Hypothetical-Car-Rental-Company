		...
		<div id="customerDetails" name="customerDetails" class="reportDiv" style="width:80%;background:#ffffff;margin:0 auto;">
			...
			<table>
				<tr>
					...
					<td><form name="updateCustomer" action="http://cs-server.usc.edu:9046/CSCI571HW/CodeIgniter_2.2.0/index.php/customerUpdate_c" method="post"><input type="submit" name="update" value="Update Details" class="button" style="display: inline; margin: 0 auto;"></form></td>
					<td><form name="updateCustomer" action="http://cs-server.usc.edu:9046/CSCI571HW/CodeIgniter_2.2.0/index.php/showAllOrders_c" method="post"><input type="submit" name="update" value="Show All Orders" class="button" style="display: inline; margin: 0 auto;"></td>
				</tr>
			</table>
		</div>	
	</body>
