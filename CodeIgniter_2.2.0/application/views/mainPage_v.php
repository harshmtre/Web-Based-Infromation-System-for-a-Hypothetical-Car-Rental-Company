	...
	<body>
		...
		if(isset($_SESSION['username']))
		{
			...
			<table width=100%>
				...
				<tr>
					<td width = "20%"><form action="http://cs-server.usc.edu:9046/CSCI571HW/logout.php"><input type="submit" name="logout" value="Logout" class="button" style="display: inline; margin: 0 auto;"></form></td>
					<td width = "40%"></td>
					<td width = "20%"><form action="http://cs-server.usc.edu:9046/CSCI571HW/CodeIgniter_2.2.0/index.php/customerMainPage_c"><input type="submit" name="signup" value="My Profile" class="button" style="display: inline; margin: 0 auto;"></form></td>
					<td width = "20%"><form action="http://cs-server.usc.edu:9046/CSCI571HW/CodeIgniter_2.2.0/index.php/cartMain_c"><input type="submit" name="signup" value="My Cart" class="button" style="display: inline; margin: 0 auto;"></form></td>
				</tr>
			</table>
			';
		}
		else
		{
			...
			<table width=100%>
				<tr>
					<td width = "20%"><form action="http://cs-server.usc.edu:9046/CSCI571HW/login.php"><input type="submit" name="login" value="Employee Login" class="button" style="display: inline; margin: 0 auto;"></form></td>
					<td width = "40%"></td>
					<td width = "20%"><form action="http://cs-server.usc.edu:9046/CSCI571HW/CodeIgniter_2.2.0/index.php/customerSignup_c"><input type="submit" name="signup" value="Customer Signup" class="button" style="display: inline; margin: 0 auto;"></form></td>
					<td width = "20%"><form action="http://cs-server.usc.edu:9046/CSCI571HW/CodeIgniter_2.2.0/index.php/customerLogin_c"><input type="submit" name="login" value="Customer Login" class="button" style="display: inline; margin: 0 auto;"></form></td>
				</tr>
			</table>
			';
		}
		echo'
			...
			<form name = "itinerary" action = "http://cs-server.usc.edu:9046/CSCI571HW/CodeIgniter_2.2.0/index.php/chooseAdditionalFeatures_c" onsubmit="return validateItinerary()" method="post" style="padding-left:10%;padding-top:2.5%;padding-bottom:2.5%;padding-right:10%">
				...
				foreach($resultSet4['resultSet4']->result_array() as $row)
				{
						...
						<tr>
							...
							<td width="20%">'.$row['specialSalesStartDate'].'</td>
							<td width="20%">'.$row['specialSalesEndDate'].'</td>
							<td width="20%">'.$row['specialSalesDiscountPercent'].'</td>
						</tr>
						';
