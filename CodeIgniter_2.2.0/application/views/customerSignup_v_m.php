...
<html>
	...
	<body>
		...
		<form name="customerSignup" action="http://cs-server.usc.edu:9046/CSCI571HW/CodeIgniter_2.2.0/index.php/customerStoreAfterSignup_c" onsubmit="return validateCustomer()" method="post" style="padding-top:2.5%;padding-bottom:2.5%">
			Username: <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="username" name="username" class="tb">
			Password: <span style="font-family:Calibri ,serif; color: red">*</span><input type="password" id="password" name="password" class="tb">
			First Name: <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerFname" name="customerFname" class="tb">
			Last Name: <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerLname" name="customerLname" class="tb">	
			Date Of Birth (yyyy-mm-dd): <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerDob" name="customerDob" onChange="javascript:checkDate()" class="tb">
			Age: <input type="text" id="customerAge" name="customerAge" onChange="javascript:checkAge()" class="rotb" readonly>
			Email: <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerEmail" name="customerEmail" class="tb" onChange="javascript:checkEmail()">	
			Phone Number: <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerPhone" name="customerPhone" class="tb" onChange="javascript:checkPhone()">	
			Address: <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerAddress" name="customerAddress" class="tb">
			Name on Credit Card: <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerCCName" name="customerCCName" class="tb">
			Billing Address: <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerBillingAddress" name="customerBillingAddress" class="tb">
			Credit Card Number: <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerCCNumber" name="customerCCNumber" maxLength="16" class="tb" onkeypress="return checkIfNumber(event)" onChange="javascript:CheckCCNumber()">
			CVV: <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerCCCVV" name="customerCCCVV" maxLength="3" class="tb" onkeypress="return checkIfNumber(event)" onChange="javascript:CheckCCCVV()">
			Credit Card Expiry Date (mm/yyyy): <span style="font-family:Calibri ,serif; color: red">*</span><input type="text" id="customerCCExpDate" name="customerCCExpDate" class="tb" onChange="javascript:checkCCExpDate()"><br/>
			<table width="100%">
				<tr>
					<td><input type="submit" name="signup" value="Submit" data-theme="b"></td>
				</tr>
				<tr>
