...
<html>
	...
	<body>
		...
		<form name="customerSignup" action="http://cs-server.usc.edu:9046/CSCI571HW/CodeIgniter_2.2.0/index.php/customerStoreAfterUpdate_c" onsubmit="return validateCustomer()" method="post" style="padding-left:10%;padding-top:2.5%;padding-bottom:2.5%">
			...
			<label>Credit Card Number: <span style="font-family:Calibri ,serif; color: red">*</span></label><input type="text" id="customerCCNumber" name="customerCCNumber" maxLength="16" value="'.$row["customerCCNumber"].'" class="tb" onkeypress="return checkIfNumber(event)" onChange="javascript:CheckCCNumber()"><br/><br/>
			<label>CVV: <span style="font-family:Calibri ,serif; color: red">*</span></label><input type="text" id="customerCCCVV" name="customerCCCVV" maxLength="3" value="'.$row["customerCCCVV"].'" class="tb" onkeypress="return checkIfNumber(event)" onChange="javascript:CheckCCCVV()"><br/><br/>
