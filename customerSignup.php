...
<html>
	...
	<body>
		...
		<form name="customerSignup" action="customerStoreAfterSignup.php" onsubmit="return validateCustomer()" method="post" style="padding-left:10%;padding-top:2.5%;padding-bottom:2.5%">
			...
			<label>Credit Card Number: <span style="font-family:Calibri ,serif; color: red">*</span></label><input type="text" id="customerCCNumber" name="customerCCNumber" maxLength="16" class="tb" onkeypress="return checkIfNumber(event)"><br/><br/>
			<label>CVV: <span style="font-family:Calibri ,serif; color: red">*</span></label><input type="text" id="customerCCCVV" name="customerCCCVV" maxLength="3" class="tb" onkeypress="return checkIfNumber(event)"><br/><br/>
	...
	$("#username").change(function(){
  		$.post("checkCustomerUsernameAvalability.php",
  		{
    		username:$(this).val()
  		},
	...
	function validateCustomer()
	{
		...
		if(message != "Please fill in the following details before proceeding: ")
  		...
  		else if(DOB == false || AGE == false || PHONE == false || EMAIL == false || CCEXP == false || USERNAME == false)
  		{
